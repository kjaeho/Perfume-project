...
def scent_letter():
    ...
    #     if G.upper() == 'M':
    #         file = open('Scent_Letter/Data/main_perf_m.txt', 'rb')
    #         my_main_frame = pickle.load(file)
    #         file.close()

    #         file = open('Scent_Letter/Data/weather_one_hot_m.txt', 'rb')
    #         my_weather_one_hot = pickle.load(file)
    #         file.close()

    #         file = open('Scent_Letter/Data/CNN_data_m.txt', 'rb')
    #         x = pickle.load(file)
    #         file.close()

    #         file = open('Scent_Letter/Data/CNN_label_m.txt', 'rb')
    #         y = pickle.load(file)
    #         file.close()

    #     elif G.upper() == 'W':
    #         file = open('Scent_Letter/Data/main_perf_w.txt', 'rb')
    #         my_main_frame = pickle.load(file)
    #         file.close()

    #         file = open('Scent_Letter/Data/weather_one_hot_w.txt', 'rb')
    #         my_weather_one_hot = pickle.load(file)
    #         file.close()

    #         file = open('Scent_Letter/Data/CNN_data_w.txt', 'rb')
    #         x = pickle.load(file)
    #         file.close()

    #         file = open('Scent_Letter/Data/CNN_label_w.txt', 'rb')
    #         y = pickle.load(file)
    #         file.close()
    ...
    while bool(test) == False:
        test = []
        test_dir = input('이미지 경로 :')
        # test_dir = 'Image-Scent/test_image/dom-hill-nimElTcTNyY-unsplash.jpg'

        ###### 형용사 CNN model section #####
        files = glob.glob(test_dir)
        CNN_model = load_model('Image_Scent/Scent_Letter/Data/형용사_45_model.h5')
#        CNN_model = load_model('Scent_Letter/Data/형용사_45_model_ver_2.h5')
    ...
    # files = glob.glob(test_dir)
    # CNN_model_w = load_model('Scent_Letter/Data/계절_5_model.h5')
    ...
    # if len(a) == 0:
    #     for i in range(0, 3):
    #         print(my_main_frame.iloc[idx[0]].sort_values(
    #             by='n_vote', axis=0, ascending=False).iloc[i, 0])
    # elif len(a) == 1:
    ...
    # elif len(a) == 2:
    #     for i in range(0, 2):
    #         print(my_main_frame.iloc[a].sort_values(
    #             by='n_vote', axis=0, ascending=False).iloc[i, 0])
    #     print(my_main_frame.iloc[idx[0]].sort_values(
    #         by='n_vote', axis=0, ascending=False).iloc[0, 0])
    # else:
    #     for i in range(0, 3):
    #         print(my_main_frame.iloc[a].sort_values(
    #             by='n_vote', axis=0, ascending=False).iloc[i, 0])
